...
const GOALS = ['Rate Limiting', 'Time Windows', '429 Too Many Requests', 'Per-User Counters']

/** "Today you'll learn" strip shown at the very top of the demo. */
export function LearningGoals() {
  return (
    <div className="flex flex-wrap items-center gap-x-4 gap-y-2 rounded-2xl bg-gradient-to-r from-rose-500/15 via-amber-500/10 to-brand-500/15 px-4 py-3 ring-1 ring-slate-700/60">
